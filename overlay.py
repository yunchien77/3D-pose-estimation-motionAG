...
folder_path = r'C:/Users/cherr/anaconda3/envs/motionAGformer/MotionAGFormer-master/demo/output/004L_sb_1_1_trans'
file_2D = r'input_2D/Angles_2D.csv'
file_3D = r'Angles_3D.csv'
...
elec = np.array(15 + df_elec['Linear Transformer Gonio G'])
